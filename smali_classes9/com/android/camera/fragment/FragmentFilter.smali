...
.field private mDrawRunnable:Ljava/lang/Runnable;
...
.method private drawRealtimeFilterOnGLThread()V
    ...
    new-instance v0, Lcom/android/camera/fragment/-$$Lambda$FragmentFilter$6Yeg5iFw5XsWzLTGBE2ByFQiJCQ;

    invoke-direct {v0, p0}, Lcom/android/camera/fragment/-$$Lambda$FragmentFilter$6Yeg5iFw5XsWzLTGBE2ByFQiJCQ;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V
...
.method private initView(Landroid/view/View;)V
    ...
    invoke-virtual {v0, v2}, Lcom/android/camera/fragment/EffectItemAdapter;->setDisplayRotation(I)V
...
.method private synthetic lambda$drawRealtimeFilterOnGLThread$1()V
    ...
    invoke-virtual {v2}, Lcom/android/camera/fragment/EffectItemAdapter$EffectItemHolder;->getEglSurface()Lcom/android/gallery3d/ui/EglWindowSurface;
    ...
    invoke-virtual {v4}, Lcom/xiaomi/camera/liveshot/gles/EglSurfaceBase;->getWidth()I

    move-result v3

    invoke-virtual {v4}, Lcom/xiaomi/camera/liveshot/gles/EglSurfaceBase;->getHeight()I

    move-result v5

    invoke-virtual {v4}, Lcom/android/gallery3d/ui/EglWindowSurface;->makeCurrent()Z
    ...
    invoke-virtual {v4}, Lcom/android/gallery3d/ui/EglWindowSurface;->swapBuffers()Z
...
.method private synthetic lambda$releaseGL$0()V
    ...
    const-string v2, "releaseGL start on GL thread map size:"
...
.method private releaseGL()V
    ...
    new-instance v2, Lcom/android/camera/fragment/-$$Lambda$FragmentFilter$7zpZDCx6LdfzmcwxfjRP6b0jM3k;

    invoke-direct {v2, p0}, Lcom/android/camera/fragment/-$$Lambda$FragmentFilter$7zpZDCx6LdfzmcwxfjRP6b0jM3k;-><init>(Lcom/android/camera/fragment/FragmentFilter;)V

    invoke-virtual {v0, v2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    :cond_1
    iput-object v1, p0, Lcom/android/camera/fragment/FragmentFilter;->mFilterGLThread:Lcom/android/gallery3d/ui/GLThread;
...
.method private supportsRealtimeEffect()Z
    ...
    invoke-virtual {v0}, Lcom/mi/config/DataItemFeature;->supportRealtimeEffect()Z
...
.method public synthetic lambda$drawRealtimeFilterOnGLThread$1$FragmentFilter()V
    .locals 0
...
.method public synthetic lambda$releaseGL$0$FragmentFilter()V
    .locals 0
...
.method public provideOrientationChanged(ILjava/util/List;I)V
    ...
    iget p0, p0, Lcom/android/camera/fragment/beauty/BaseBeautyFragment;->mScreenOrientation:I

    invoke-static {p0}, Lcom/android/camera/Display;->getDegreeByScreenOrientation(I)I

    move-result p0

    sub-int/2addr p1, p0

    invoke-virtual {p2, p1}, Lcom/android/camera/fragment/EffectItemAdapter;->setDisplayRotation(I)V
